...
def calculate_local_features(data):
    ...
    try:
        ...
        # Debug: Log raw data for problematic compounds
        # debug_compounds = ['Ag1Cl1O4', 'Ag1Na1O1', 'Ag1K1O1', 'Ag1O1Rb1', 'Ag1O1', 'Ag4O12Sb4', 
        #                    'Ag4Mo2O8', 'Ni4O8Si2', 'Eu4O14Sn4', 'Ni1O1', 'Ag26O12Os2', 
        #                    'Cu12O4Ti12', 'Ge1In7Ir1O8', 'Fe8O4Ti16']
        
        # if data.get('compound') in debug_compounds:
        ...
        for idx, site in enumerate(structure):
            ...
            # if coordination_number == 0 and data.get('compound') in debug_compounds:
